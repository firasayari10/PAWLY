...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "Créer une offre", href: "/main/offers/create" },
  ];
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        <div
          className={`bg-white/80 backdrop-blur-xl border border-white/20 shadow-lg shadow-teal-900/5 rounded-[2rem] px-6 py-4 flex items-center justify-between transition-all duration-300 ${
        ...
        >
          ...
          <Link
            href="/main/landing"
            className="flex items-center gap-2 text-2xl font-black tracking-tighter hover:scale-105 transition-transform"
            style={{ fontFamily: "'Fraunces', serif", color: "#1E7A6B" }}
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="md:hidden w-10 h-10 flex items-center justify-center bg-teal-50 text-teal-600 rounded-xl"
            >
          ...
          <div className="flex flex-col gap-4">
            {navLinks.map((link) => (
              <Link
                ...
                className={`p-4 rounded-2xl font-black uppercase text-sm ${
                  pathname === link.href
